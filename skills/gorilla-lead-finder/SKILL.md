...
description: Find your first SaaS users by searching Reddit, X, YouTube, LinkedIn, and Bluesky for people already describing the problem your product solves. Ranks every result by buying intent and drafts platform-tuned outreach. Backed by the Gorilla API at https://usegorilla.app.
---
...
2. **Searches five platforms at once**: Pulls recent posts from Reddit, X, YouTube, LinkedIn, and Bluesky where people describe the relevant problem. LinkedIn is a paid-plan source; the free tier covers the other four.
...
5. **Drafts platform-tuned outreach**: For each lead the founder picks, generates a Reddit-paragraph, X-reply, YouTube-comment, LinkedIn reply, or Bluesky reply that follows that platform's conventions.
...
Configure in Claude Code or Cursor. Sign up at https://usegorilla.app to get a `GORILLA_API_KEY`. Pricing: start free with 100 credits, no card. Paid plan is $14.99/mo for 2,000 credits with rollover. You spend one credit per qualified lead (hot or warm); low-relevance results are free.
